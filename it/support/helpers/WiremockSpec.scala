...
@deprecated("This trait will be removed. Use WireMockServer instead.")
trait WiremockSpec extends BeforeAndAfterEach with BeforeAndAfterAll with GuiceOneServerPerSuite
  ...
  lazy val connectedServices: Seq[String] = Seq("des", "income-tax-benefits", "income-tax-expenses", "integration-framework")
