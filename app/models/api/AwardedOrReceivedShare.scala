...
import models.api.ShareAwardedShareSchemePlanType.SchemePlanType
import play.api.libs.json.{Json, OFormat}

import java.time.LocalDate

case class AwardedOrReceivedShare(employerName: String,
...
object AwardedOrReceivedShare {
  implicit val format: OFormat[AwardedOrReceivedShare] = Json.format[AwardedOrReceivedShare]
}