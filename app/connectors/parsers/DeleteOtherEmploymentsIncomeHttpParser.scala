...
object DeleteOtherEmploymentsIncomeHttpParser extends DESParser with Logging {
  type DeleteOtherEmploymentsIncomeResponse = Either[ApiError, Unit]

  override val parserName: String = "DeleteOtherEmploymentsIncomeHttpParser"
  ...
  implicit object DeleteOtherEmploymentsIncomeHttpReads extends HttpReads[DeleteOtherEmploymentsIncomeResponse] {
    ...
    override def read(method: String, url: String, response: HttpResponse): DeleteOtherEmploymentsIncomeResponse = {
