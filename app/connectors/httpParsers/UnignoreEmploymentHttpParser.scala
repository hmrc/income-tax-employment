...
object UnignoreEmploymentHttpParser extends DESParser with Logging{
  type UnignoreEmploymentResponse = Either[DesErrorModel, Unit]

  override val parserName: String = "UnignoreEmploymentHttpParser"
  override val isDesAPI: Boolean = true

  implicit object UnignoreEmploymentHttpReads extends HttpReads[UnignoreEmploymentResponse] {
