...
object DeleteEmploymentHttpParser extends DESParser with Logging {
  type DeleteEmploymentResponse = Either[DesErrorModel, Unit]

  override val parserName: String = "DeleteEmploymentHttpParser"
  override val isDesAPI: Boolean = true

  implicit object DeleteEmploymentHttpReads extends HttpReads[DeleteEmploymentResponse] {
