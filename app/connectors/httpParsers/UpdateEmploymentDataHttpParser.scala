...
object UpdateEmploymentDataHttpParser extends DESParser with Logging{
  type UpdateEmploymentDataResponse = Either[DesErrorModel, Unit]

  override val parserName: String = "UpdateEmploymentDataHttpParser"
  override val isDesAPI: Boolean = true

  implicit object UpdateEmploymentDataHttpReads extends HttpReads[UpdateEmploymentDataResponse] {

    override def read(method: String, url: String, response: HttpResponse): UpdateEmploymentDataResponse = {
