...
class CreateUpdateOtherEmploymentsIncomeHttpParserSpec extends UnitTest {
  ...
  private val underTest = CreateUpdateOtherEmploymentsIncomeHttpParser.CreateUpdateOtherEmploymentsIncomeHttpReads

  "CreateUpdateOtherEmploymentsIncomeHttpReads" should {
    "convert JsValue to CreateUpdateOtherEmploymentsIncomeResponse" when {
